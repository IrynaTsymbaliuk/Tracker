...
lifecycleScope.launch {
    ...
    try {
        ...
        movies?.sessions           // List<MovieSession> — title, watchedDate, publishedDate,
                                   //   tmdbId, rating, review, isRewatch, isLiked
        ...
        // rating (0.5–5.0) and review are null when the entry wasn't rated / reviewed;
...
| **MOVIE_WATCHING** | Letterboxd RSS | Film titles, watch dates, TMDB ids, plus the user's rating, review, rewatch flag, and like flag from public feed | `INTERNET` (no user prompt) |
